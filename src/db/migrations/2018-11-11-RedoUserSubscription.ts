...
import { User, UserStripeSubscription, StripeData } from '../models/User';
import commissions from '../../resolvers/Mutations/commissions';
import { UserSubscription } from '../models/UserSubscription';
import { find } from 'lodash';
import { getCustomer, getProduct, getPlan, getSubscription } from '../../helpers/stripe';
import moment = require('moment');
import { StripeCustomerReference, StripePlanReference, StripeProductReference } from '../../interfaces/stripe';
import { IUserSubscription } from '../../interfaces/users';
...
export default {
  ...
  up: async (store: IDocumentStore) => {
    ...
    for (let us of userSubscriptions) {
      console.log(us.id);
      us.type = 'Stripe';
